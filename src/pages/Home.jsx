          ...
          <div className=" w-full flex flex-row justify-between items-start p-4 bg-[#121525] ">
            ...
            <div className="bg-[#1c1e2f] rounded-xl  p-4 m-2 flex flex-col justify-between items-center h-35">
              <div>
                ...
                <button className="m-1 px-3 py-1 text-xs bg-[#3ec6ff] text-black font-semibold rounded-full">
                  Invite friends
                </button>
              </div>
              <img
            ...
            <div className="grid grid-cols-1 gap-3">
              <button className="flex items-center bg-[#1c1e2f] rounded-lg p-3 gap-2 text-sm text-white">
